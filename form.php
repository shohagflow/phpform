...
$bangladeshCities = ["Dhaka", "Chittagong", "Khulna", "Rajshahi", "Sylhet", "Barisal", "Rangpur", "Narayanganj", 
...
if(isset($_POST['reg123']) && $_POST['reg123'] == 'sign up'){
    ...
    if (isset($crrName) && isset(  $crrEmail) && isset( $crrAge) && isset($crrGen) && isset($crrHob) && isset( $crrCity)){
       ...
       $name=$email=$age=$gender=$hobbies=$city = null;
       $crrName=$crrEmail=$crrAge=$crrGen=$crrHob=$crrCity=null;
    }
        ...
        <div class="row min-vh-100">
            <div class="col md-5 m-auto border round shadwo p-4">
                ...
                <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
                  ...
                  <!--Gender field--------------------->
                    <div class="mb-1 <?= isset($errorGen ) ?"border border-danger":null ?> py-1 rounded position-relative">
                        <div class="gender ml-2 position-relative">                            
                            ...
                            <?php if( isset($errorGen)){ ?>
                                <i class=" bi bi-exclamation-circle text-danger position-absolute top-0 end-0"></i> 
                                <?php }?>                            
                        </div>
                    </div>                    
                    ...
                    <div class="mb-1 <?=isset( $errorHobbies) ? "border border-danger py-1 rounded":null ?> ">         
                        ...
                        <i class="bi bi-exclamation-circle text-danger position-absolute end-0 top-0 translate-middel fw-bold"></i> 
                        <?php } ?>
                    </div>
                        ...
                        <div class="mb-3 ">
                            <select name="city" class="form-select form-control my-1 <?= isset($errorCity)? "is-invalid":null ?>">
                                ...
                                <option value="<?=$city ?>" <?= isset($crrCity) && $crrCity == $city ? "selected":null ?>><?=$city ?></option>
                               <?php } ?>
                            </select>
